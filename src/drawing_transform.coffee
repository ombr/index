...
class DrawingTransform
  ...
  init: ->
      ...
      center,
      {
        ...
        move: (position)=>
          ...
          DrawingUtils.apply_matrix(
            @element, @referentiel._multiply(translation_matrix, matrix)
          )
        end: (position)=>
          @options.end()
          @init()
    ...
    transform_handle_center_distance = Geometry.distance(
      center,
        ...
        element: =>
          ...
          icon = DrawingUtils.create_element(
            ...
            'path',
            {
              ...
              25.9-32.1 41-17l36.2 36.2L184.5 256 77.2 148.7 41 185c-15.1 \
              15.1-41  4.4-41-17V56c0-13.3 10.7-24 24-24h112c21.4 0 32.1 25.9 \
              17 41l-36.2 36.2L224 216.4l107.3-107.3L295.1 \
              73c-15.1-15.1-4.4-41 17-41h112c13.3 0 24 10.7 24 \
              24v112c0 21.4-25.9 32.1-41 17l-36.2-36.2L263.6 \
  ...
  destroy: ->
    ...
    @transform_handle.destroy()
    @drag.destroy()
export default DrawingTransform
